...
type
  TfrmChildDish = class(TForm)
    ...
    procedure btnSearchDataClick(Sender: TObject); // Клавіша "Пошук"
    procedure btnClearFormClick(Sender: TObject); // Клавіша "Очистити"
  private
    nameTfrmChildDish: string;
    function transferStrNumberForSql(myStr: string): string; // Отримання строки числа для SQL-запиту
  public
    function getNameTfrmChildDish(): string; // Отримання строки з назвою форми
  end;
...
function TfrmChildDish.getNameTfrmChildDish(): string; // Отримання строки з назвою форми
begin
  getNameTfrmChildDish := nameTfrmChildDish;
end;

function TfrmChildDish.transferStrNumberForSql(myStr: string): string; // Отримання строки для SQL-запиту
var
  returnString: string;
...
procedure TfrmChildDish.btnSearchDataClick(Sender: TObject); // Клавіша "Очистити"
var
...
procedure TfrmChildDish.btnClearFormClick(Sender: TObject); // Клавіша "Очистити"
begin
