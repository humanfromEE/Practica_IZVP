...
uses
  ...
  Dialogs, Grids, DBGrids, UnitDMVFP, { Data Module для імпорту БД з Visual FoxPro }
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          TblDBworker.First;
          questionMB := 'Дані не знайдено за кодом "' + codeForSearch + '", перевірте коректність вводу (ввід у форматі "ХХХw", де Х - це цифра)';
