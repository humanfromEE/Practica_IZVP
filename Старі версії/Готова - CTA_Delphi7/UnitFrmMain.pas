...
uses
  ...
  ShellAPI { Для відкриття файлу довівдки },
  Grids, DBGrids, StdCtrls { Відкриття файлу довідки } ;
...
type
  TfrmMain = class(TForm)
    ...
    procedure MnTabReportsItemSupplyProductInJanuary2023Click(Sender: TObject);
