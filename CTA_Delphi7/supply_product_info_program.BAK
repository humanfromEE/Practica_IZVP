...
countSupplyProduct = getcountSupplyProduct()
...
GOTO TOP
codeSupplyProductNow = ""
IF (NOT EOF()) THEN
	CLOSE TABLES ALL 
	FOR counterOrderForOutput = 1 TO countSupplyProduct	STEP 1
		codeSupplyProductNow = getCodeSupplyProduct(counterOrderForOutput)
		...
		DO WHILE (.T.)
			IF (codeSupplyProductNow == code_sp) THEN
				...
				@ xPointer, yFieldCountSupplyProduct SAY STR(count_sp, INT(lengthIntegerNumber(count_sp)), 0)
