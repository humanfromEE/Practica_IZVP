object frmMain: TfrmMain
  ...
  object menuFrmMain: TMainMenu
    ...
    object MnTabQueries: TMenuItem
      ...
      object MnTabQueriesItemName_product_is_dish_head_product_query: TMenuItem
        Caption = #1053#1072#1079#1074#1072' '#1087#1088#1086#1076#1091#1082#1090', '#1076#1077' '#1091' '#1089#1090#1088#1072#1074#1110' '#1074#1110#1085' '#1108' '#1075#1086#1083#1086#1074#1085#1080#1084
        OnClick = MnTabQueriesItemName_product_is_dish_head_product_queryClick
      end
      object MnTabQueriesItemProviders_in_lviv_query: TMenuItem
        Caption = #1055#1086#1089#1090#1072#1095#1072#1083#1100#1085#1080#1082#1080' '#1091' '#1051#1100#1074#1086#1074#1110
        OnClick = MnTabQueriesItemProviders_in_lviv_queryClick
      end
    end
    object MnTabReports: TMenuItem
      Caption = #1047#1074#1110#1090#1080
      object MnTabReportsItemSupplyProductInJanuary2023: TMenuItem
        Caption = #1047#1074#1110#1090' '#1087#1086#1089#1090#1072#1095#1072#1085#1085#1103' '#1079#1072' '#1089#1110#1095#1077#1085#1100' 2023'
        OnClick = MnTabReportsItemSupplyProductInJanuary2023Click
      end
      object MnTabReportsItemWorkSalary: TMenuItem
        Caption = #1047#1074#1110#1090' '#1079#1072#1088#1087#1083#1072#1090' '#1087#1088#1072#1094#1110#1074#1085#1080#1082#1110#1074
        OnClick = MnTabReportsItemWorkSalaryClick
      end
      object MnTabReportsItemMenuReport: TMenuItem
        Caption = #1052#1077#1085#1102
        OnClick = MnTabReportsItemMenuReportClick
      end
      object MnTabReportsItemMostCountOrder: TMenuItem
        Caption = #1047#1074#1110#1090' '#1085#1072#1081#1073#1110#1083#1100#1096#1110' '#1079#1072#1084#1086#1074#1083#1077#1085#1085#1103
        OnClick = MnTabReportsItemMostCountOrderClick
      end
    end
